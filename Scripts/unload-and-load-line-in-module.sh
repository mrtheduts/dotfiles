...
pactl load-module module-alsa-card device_id="$CARDID" name="$NAME" card_name="alsa_card.$NAME" namereg_fail=false tsched=no fixed_latency_range=yes ignore_dB=no deferred_volume=yes use_ucm=yes card_properties="module-udev-detect.discovered=1" fragments=2 fragment_size=25
